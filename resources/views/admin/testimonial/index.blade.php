      ...
      <div class="col-12">
        <div class="card mb-4">
          <div class="card-header pb-0 d-flex" style="justify-content: space-between;">
            <h6>Testimonials</h6>
            <a class="btn btn-sm btn-primary" href="{{route('addTestimonialView')}}">Add New</a>
          </div>
                        ...
                        {{-- <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm">{{$testimonial->id}}</h6>
                            </div>
                          </div>
                        </td> --}}
                        <td>
                          <p class="text-xs font-weight-bold mb-0">{{substr($testimonial->description,0,130)}}</p>
                        </td>
                        {{-- <td class="align-middle text-center text-sm">
                            <p class="text-xs text-secondary mb-0">{{strlen($attorney->bio) > 50 ? substr($attorney->bio, 0, 50) . '...' : $attorney->bio}}</p>
                        </td> --}}
                        <td class="align-middle">
                          <a href="{{route('edit.testimonial.view',$testimonial->id)}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" >
                          ...
                          <a  href="{{ route('delete.testimonial',$testimonial->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" >
