        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Opinion Information</p>
                        <form action="{{route('opinions.update',$opinions->id)}}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="title" class="form-control" type="text"
                                               value="{{ $opinions->title }}" placeholder="title" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description" class="form-control" id="editor2" rows="6"
                                                  ...
                                                  required>{{ $opinions->short_description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" rows="6" id="editor"
                                                  ...
                                                  required>{{ $opinions->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div id="banner_image-preview-container" class="col-md-6">
                                    <img id="banner_image-preview" width="100px" height="100px"
                                         src="{{ Storage::url($opinions->image) }}" alt="Image Preview">
                                </div>
                ...
                $(document).ready(function () {
                    $("#banner_image").change(function () {
                        ...
                        if (file) {
                            ...
                            $("#banner_image-preview").attr("src", "{{ Storage::url($opinions->image) }}");
                        }
                    });
                });
            </script>
