            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex" style="justify-content: space-between;">
                        <h6>Opinions</h6>
                        <a class="btn btn-sm btn-primary" href="{{route('opinions.create')}}">Add New</a>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach ($opinions as $opinion)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ Storage::url($opinion->image) }}" class="rounded-circle"
                                                 width="50" height="50"/>
                                        </td>
                                        <td class="align-middle text-center text-sm">
                                            <p>{{ strlen($opinion->short_description) > 50 ? substr($opinion->short_description, 0, 50) . '...' : $opinion->short_description }}</p>
                                        </td>

                                        <td class="align-middle text-center text-sm">
                                            <p>{{ strlen($opinion->description) > 50 ? substr($opinion->description, 0, 50) . '...' : $opinion->description }}</p>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                <!-- Edit Button -->
                                                <a href="{{ route('opinions.edit', $opinion->id) }}"
