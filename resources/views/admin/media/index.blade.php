            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex" style="justify-content: space-between;">
                        <h6>Media</h6>
                        <a class="btn btn-sm btn-primary" href="{{route('media.create')}}">Add New</a>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach ($medias as $media)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ Storage::url($media->thumbal) }}" class="rounded-circle"
                                                 width="50" height="50"/>
                                        </td>

                                        <td>{{ $media->video_link}}</td>

                                        <td class="align-middle text-center text-sm">
                                            <p>{{ strlen($media->short_description) > 50 ? substr($media->short_description, 0, 50) . '...' : $media->short_description }}</p>
                                        </td>

                                        <td class="align-middle text-center text-sm">
                                            <p>{{ strlen($media->description) > 50 ? substr($media->description, 0, 50) . '...' : $media->description }}</p>
                                        </td>
