        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex align-items-center">
              <p class="mb-0">Add Out Reach</p>
            </div>
          </div>
          <div class="card-body">
            <p class="text-uppercase text-sm">Out Reach Information</p>
            <form action="{{route('add.new.out.reach')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="short_description" class="form-control" rows="4" placeholder="Short Description..." required></textarea>
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
