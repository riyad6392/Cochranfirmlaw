            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex" style="justify-content: space-between;">
                        <h6>Media Reel</h6>
                        <a class="btn btn-sm btn-primary" href="{{route('media-reel.create')}}">Add New</a>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                @foreach ($media_reels as $media_reel)
                                    <tr>
                                        <td>{{ $media_reel->title }}</td>

                                        <td>
                                            <img src="{{ Storage::url($media_reel->thumbal) }}" class="rounded-circle"
                                                 width="50" height="50"/>
                                        </td>
                                        <td>{{ $media_reel->video_link}}</td>


                                        <td class="align-middle">
                                            <div class="d-flex">
                                                <!-- Edit Button -->
                                                <a href="{{ route('media-reel.edit', $media_reel->id) }}"
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ route('media-reel.destroy', $media_reel->id) }}"
