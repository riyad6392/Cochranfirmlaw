            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex" style="justify-content: space-between;">
                        <h6> SEO Backend Pages</h6>
                        <a class="btn btn-sm btn-primary" href="{{ route('add.new') }}">Add New</a>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($pages as $page)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $page->head_one }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $page->head_two }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('edit.page',$page->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" >
                                                ...
                                                <a  href="{{ route('delete.record',$page->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user" >
                                            ...
                                            {{-- <td>
                                                <p class="text-xs font-weight-bold mb-0">{{ $page->description }}</p>
                                            </td> --}}
                                        </tr>
                                    @endforeach
                                </tbody>
