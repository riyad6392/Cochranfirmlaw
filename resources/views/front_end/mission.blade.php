                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 d-flex align-items-stretch sm_under_links under_links mt-3">
                                ...
                                <a href="{{ route('mission', $mission->id) }}" class="breadcrumb-active-link">
                                    <h5>{{ $mission->title }}</h5>
                                </a>
        ...
        <div class="row" style="margin-left: 25px; padding-right:40px;">
            ...
            {{-- <h1 style=" box-sizing: border-box;
                 margin-bottom: -30px;
                  ...
                  opacity: 0.8;">{{ $mission->title }}</h1> --}}
            {{-- <p style="left: 0px; font-family: Montserrat; font-weight: 500; line-height: 1.8em; padding-bottom: 1em; text-align: justify;">{!! $mission->description !!}</p> --}}
            {!! $mission->description !!}
